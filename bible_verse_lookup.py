...
KLOVE_URL = "https://www.klove.com/devotionals/verse-of-the-day"
...
KLOVE_SELECTORS = [".verse-of-the-day", ".votd", "[class*='verse-of-the-day']", "[class*='votd']"]
...
def fetch_klove_verse(page) -> tuple[str, str]:
    ...
    page.goto(KLOVE_URL, wait_until="networkidle", timeout=30000)

    for selector in KLOVE_SELECTORS:
